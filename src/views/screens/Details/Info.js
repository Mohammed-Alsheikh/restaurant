...
export default ({Order}) => {
  const addressInfo = Order.get('addressInfo');
  ...
  return (
    <Container>
      ...
      <List.Item
        title="Name"
        description={client.get('firstName') + ' ' + client.get('surName')}
        left={props => (
          <List.Icon {...props} icon="account-box" color={Colors.primary} />
        )}
      />
      {driver && (
        <React.Fragment>
          ...
          <List.Item
            title="Driver Name"
            description={driver.get('firstName') + ' ' + driver.get('surName')}
            left={props => (
              <List.Icon {...props} icon="account-box" color={Colors.primary} />
            )}
          />
